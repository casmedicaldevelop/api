...
exports.TvMedEventoService = void 0;
...
let TvMedEventoService = class TvMedEventoService {
    prisma;
    constructor(prisma) {
        this.prisma = prisma;
    }
    ...
    async findOne(id) {
        ...
        if (!record)
            throw new common_1.NotFoundException(`Registro tvmed_evento con id ${id} no encontrado.`);
        return record;
    }
    async findByCum(cum) {
...
exports.TvMedEventoService = TvMedEventoService;
exports.TvMedEventoService = TvMedEventoService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService])
], TvMedEventoService);
//# sourceMappingURL=tvmed-evento.service.js.map